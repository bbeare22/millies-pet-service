    ...
    <section className="hero-watermark">
      <div className="container py-10 md:py-16 grid md:grid-cols-2 gap-8 md:gap-10 items-center">
        <div>
          ...
          <p className="mt-3 text-base sm:text-lg text-gray-700 max-w-prose">
            Reliable, insured, and pet-first care for your best friend. Book walks, drop-ins, and overnight sitting.
          </p>
          <div className="mt-5 grid grid-cols-2 gap-3 sm:flex sm:flex-wrap">
            <Link href="/book" className="btn w-full sm:w-auto text-center">Book Now</Link>
            <Link href="/services" className="btn-ghost w-full sm:w-auto text-center">View Services</Link>
          </div>
